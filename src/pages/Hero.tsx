    ...
    return (
        ...
        <AnimatedContainer delay={300} className="mt-0 md:pl-0">
            <div className="flex flex-col mt-4 md:justify-center md:items-center items-start" id="home">
                <h1 className="text-4xl md:text-6xl text-center bg-gradient-to-b from-gray-100 via-gray-300 to-gray-500 bg-clip-text text-transparent lexend-deca-700 tracking-tighter">Hi. Hello. Welcome.</h1>
