...
const Projects = () => {
    return (
        <div className="h-full flex flex-col justify-center md:items-center p-4 md:p-6">
            <ProjectsRender renderCount={6} animateDelay={100}></ProjectsRender>
            <ProjectsRender data={UIDesigns} renderCount={3} title="UI Designs" animateDelay={300}></ProjectsRender>
        </div>
    )
}
